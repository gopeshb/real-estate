...
export default function Home() {
  ...
  return (
    <div className='w-full flex flex-col mx-auto bg-[#0d192b]'>
      <div className='title-container max-w-3xl mx-auto items-center object-contain invert rounded-full drop-shadow-xl hue-rotate-50 shadow-lg 
      shadow-blue-800 flex flex-col flex-wrap justify-center w-full text-center h-[440px] '
       style={{ backgroundImage: 'url(https://firebasestorage.googleapis.com/v0/b/real-estate-315ad.appspot.com/o/background-img.jpg?alt=media&token=ce7b97ae-f405-4f9e-b51a-e81db70524ac)' }}>
        <p className='p-3 m-2 rounded-lg title-left text-3xl font-bold text-gray-300 bg-gradient-to-r  from-green-400 to-blue-500'>Are You Looking For A New Home?</p>
        <p className='title-right text-3xl rounded-lg text-teal-900 bg-gradient-to-r from-sky-500 to-blue-500 p-3 font-bold'>Try 
