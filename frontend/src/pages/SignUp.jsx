...
export default function SignUp() {
  ...
  return (
    <div className="p-3 max-w-md mx-auto my-8 bg-white rounded-lg shadow-md">
      ...
      <form className="flex flex-col gap-5 mx-3" onSubmit={submitHandler}>
        ...
        <button
          disabled={loading}
          className="bg-slate-700 text-white py-2 px-4 rounded-lg uppercase disabled:opacity-50 hover:opacity-90"
        >
