...
export default function SignIn() {
  ...
  return (
    <div className="p-2 max-w-md mx-auto my-8 bg-white rounded-lg  ">
      ...
      <form className="flex flex-col gap-4 mx-3" onSubmit={submitHandler}>
        ...
        <button
          disabled={loading}
          className="bg-slate-700 text-white p-2 rounded-lg uppercase text-sx text-center font-semibold disabled:opacity-50 hover:opacity-90"
        >
